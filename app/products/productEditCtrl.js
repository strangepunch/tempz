(function() {
	...
	function ProductEditCtrl(product, $state, productService) {
		...
		vm.product = product; //prevent the need to use 'copy' because every operation uses the latest version of product data from web server
		...
		/*calculate the price based on a markup based on amount or percent*/
		...
		vm.removeTag = function (idx) { //passing in the index of the tag to remove
