	...
	var tastes = [
		...
		var strains = [
			...
			{"strainId": 12,
			 ...
			 "positiveEffects": ["Intense effects", "Mind and Body Buzz", "Euphoric", "Happy", "Uplifted", "Relaxed", "Creative"],
			...
			{"strainId": 14,
			 ...
			 "positiveEffects": ["Sleepy", "Euphoric", "Relaxed", "Uplifted", "Hungry"],
			...
			{"strainId": 23,
			 ...
			 "positiveEffects": ["Relaxing", "Sleepy", "Happy", "Euphoric", "Hungry"],
